...
<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-xl p-8">
        ...
        <h3 class="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6 border-b pb-2 border-gray-200 dark:border-gray-700">
            Edit Detail Matakuliah
        </h3>

        {{-- Notifikasi Error yang konsisten --}}
        @if ($errors->any()) 
        ...
        {{-- Menggunakan route update dan Method Spoofing PUT --}}
        <form action="{{ route('matakuliah.update', $matakuliah->id) }}" method="POST"> 
            ...
            <div class="mb-5"> 
                ...
                <input type="text" 
                    ...
                    required autofocus placeholder="Contoh: CS401"> 
            ...
            <div class="mb-5"> 
                ...
                <input type="text" 
                    ...
                    required placeholder="Contoh: Algoritma dan Struktur Data"> 
            ...
            <div class="mb-5"> 
                ...
                <input type="number" 
                    ...
                    required min="1" max="6" placeholder="Masukkan jumlah SKS (1-6)"> 
            ...
            <div class="flex gap-3 pt-2">
                {{-- Tombol Simpan Perubahan (Primary -> Indigo) --}}
