...
{{ __('Input Data Ruang Kuliah Baru') }}
</h2>
@endsection
...
<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-xl p-8">
        ...
        {{-- Form Tambah Ruang Kuliah. Perhatikan enctype untuk upload file. --}}
        <form action="{{ route('ruang_kuliah.store') }}" method="POST" enctype="multipart/form-data"> 
            ...
            <div class="mb-5"> 
                ...
                <input type="text" 
                    ...
                    id="kode_ruangan" name="kode_ruangan" value="{{ old('kode_ruangan') }}" required placeholder="Contoh: R.401"> 
            ...
            <div class="mb-5"> 
                ...
                <input type="text" 
                    class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" 
                    id="nama_ruangan" name="nama_ruangan" value="{{ old('nama_ruangan') }}" required placeholder="Contoh: Laboratorium Pemrograman"> 
                @error('nama_ruangan')<p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>@enderror
            </div> 

            {{-- Input Foto Ruangan (File) --}}
            <div class="mb-5"> 
                <label for="foto_ruangan" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Foto Ruangan (Opsional)</label> 
                <input type="file" 
